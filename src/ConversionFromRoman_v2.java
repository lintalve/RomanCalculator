...
public class ConversionFromRoman_v2 {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        for (int i=0; i<charArray.length; i++) {
            ...
            if (i<charArray.length-1 && charArray[i] < charArray[i + 1]) outputArabicNumber -= Roman.valueOf(String.valueOf(charArray[i])).arabic;
